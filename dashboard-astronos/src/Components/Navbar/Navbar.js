...
import Bannerlogo4 from '../../Assets/bannerlogo4.png';
...
export default function Navbar(){
    ...
    return(
        ...
        <nav>
            <div className="logo">
                <img src={Bannerlogo4} />
                 {/* <p className="AdaName">  Astronos</p>  */}
            </div>
            ...
            <div className="addressInput">
                ...
                <input onInput={(e)=>{setLoadingData(true); setGetAccount(e.target.value)}} id="walletAddress" placeholder="Paste wallet address" />
            </div>
